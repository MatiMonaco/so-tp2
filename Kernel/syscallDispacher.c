...
static SystemCall syscall_array[] = {0,(SystemCall)sys_getWidth,(SystemCall)sys_getHeight,(SystemCall)sys_read,(SystemCall)sys_write,(systemCall) _beep,(SystemCall)sys_drawRect,(SystemCall) sys_sleep};
